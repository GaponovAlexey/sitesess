import { merriweather, montserrat, one } from "../../app/fonts"
import s from "../../styles/main.module.scss"

const Landing = () => {
  return (
    <section>
      <div id="landing" className={s.landing}>
        <div className={s.landing_use}>
          <div className={s.landing_use_top}>
            ...
            <p>
              ...
              think a website makes your business more credible than companies
              who only have social media profiles. <br /> Your website is also
              the <strong className="text-blue-700" > perfect place to show </strong> off any professional
          ...
          <div className={s.landing_use_bottom}>
            ...
            <div>
              <h2>
                You can display your best reviews and testimonials prominently
                on your website
              </h2>
              <p>
                Displaying your best reviews and/or testimonials prominently on
                your website is a great way to establish social proof. This
                might come in the form of personal customer testimonials
              </p>
            </div>
            {/* 3 */}
            <div>
              ...
              <p>
                A website is a great place to make your contact information
                easily available to potential customers.
              </p>
            </div>
            {/* 4 */}
            <div>
              <h2>
                You can integrate your website with Google Maps so people can
            ...
            <div>
              ...
              <p>
                ...
                Your website can save you that time by providing answers to
                common customer questions and inquiries. What does this mean for
                you? You can spend your time doing more valuable things.
              </p>
            </div>
          </div>
        </div>
