    ...
    <div className="relative  z-4">
      <section id="application">
        ...
        <div className="absolute top-0 left-0 container px-4 md:px-12 left-19 py-4 ">
          <form
            className="lg:w-1/3 md:w-1/2 bg-white dark:bg-[#111827] rounded-lg p-8 flex flex-col md:ml-auto  mt-20 sm:mt-0 relative z-10 shadow-md"
            onSubmit={add}
          >
            <h2 className="text-lg mb-1 font-medium title-font text-center">
              Give us a shout. We&apos;re all ears.
            </h2>
            ...
            <p className="text-xs text-center  mt-3">
              Let&apos;s communicate! Don&apos;t hesitate to contact us with your
              projects, ideas, and questions.
            </p>
            <button className="inline-block text-black">
              <CustomBut name="Contact Us" color="red-200" />
            </button>
            <p className="text-xs text-center  mt-3">
